...
console.log(chalk.bgBlack(chalk.bold.redBright("Configure el archivo 'config.js' porque su número de WhatsApp no comienza con el código de país, Ejemplo: +52133xxxx")))
process.exit(0)
}} else {
while (true) {
...
if (connection == 'open') {
console.log(chalk.yellowBright('\n╭───────────────────────────◉\n│\n│NigromanteBot conectado correctamente al WhatsApp.\n│\n╰───────────────────────────◉\n'))
//conn.fakeReply('5213331199136@s.whatsapp.net', '😃', '0@s.whatsapp.net', '😅 Soy NigromanteBot\nRecientemente me e conectado', '0@s.whatsapp.net')
}
