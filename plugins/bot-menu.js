//CÓDIGO ADAPTADO POR https://github.com/diegojadibot | @diego_oficial & https://github.com/AzamiJs | @Azami
...
const fload = { key : { message: `NigromanteBot-MD 🍧` + `\nsinombre913.21`, thumbnail: await (await fetch(pp)).buffer(), sellerJid: '0@s.whatsapp.net' }}

m.react('💀')
  
let menu = `*☠️ Hᴇʏʏ, ${name}*

.allmenu
_(Pᴀʀᴀ Vᴇʀ Eʟ Mᴇɴᴜ: Bʏ - NɪɢʀᴏᴍᴀɴᴛᴇBᴏᴛ)_`
