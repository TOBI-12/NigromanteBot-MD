...
let res = await fetch('https://api.github.com/repos/Sinombre913/NigromanteBot-MD')
...
await conn.sendUrl(m.chat, git, m, { externalAdReply: { mediaType: 1, renderLargerThumbnail: true, thumbnail: imagen2, thumbnailUrl: imagen1, title: '\t\t\t\t\t\t᭡͡ᩬ🍧✩̣̣̣̣̣ͯNigromanteBot-MD᭡͡ᩬ🍧✩̣̣̣̣̣ͯ', }})
